...
void test_player_constructor() {
  ...
  if (player.getPlayersInventory() == nullptr) {
    cout << "Default Player constructor failed; Player inventory ptr is a "
            "nullptr!"
         << endl;
    return;
  }
  ...
  if (player.getDirection() != Player::MoveDirection::North) {
    cout << "Default Player constructor failed; Player direction is not South!"
         << endl;
    return;
  }
...
void test_player_inventory() {
  ...
  // Check if set
  if (player.getPlayersInventory() == nullptr) {
    cout << "Player inventory reassignment failed; Player inventory ptr is a "
            "nullptr!"
         << endl;
    return;
  }
...
void test_player_position() {
  ...
  if (player.getPosition() != coord(1, 1)) {
    cout << "Player position reassignment failed; Player position is not (1,1)!"
         << endl;
    return;
  }
  ...
  if (player.getPosition() != coord(2, 2)) {
    cout << "Player move function failed; Player position is not (2,2)!"
         << endl;
    return;
  }
