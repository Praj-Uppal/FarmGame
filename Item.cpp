...
//Define constructor. First value is buy cost, followed by sell cost, and lastly the name of the item
Item::Item(int buy, int sell, string name) : buyCost(buy), sellCost(sell), name(name) {};
...
//Define Set methods. Simply sets the corresponding variable to the provided value.
