...
{
protected:
    // Define Item Attributes including sell cost, buy cost, if its plantable and its name
...
public:
    ...
    // Public Method to get variable values. Const to ensure they dont change attribute values.
