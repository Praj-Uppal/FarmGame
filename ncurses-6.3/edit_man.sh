...
TERMINFO="/home/spagett/docs/UNI/oop/FARM-GAME-1/ncurses/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f "/home/spagett/docs/UNI/oop/FARM-GAME-1/ncurses-6.3/man_alias.sed" ; then
cat >>/home/spagett/docs/UNI/oop/FARM-GAME-1/ncurses-6.3/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/spagett/docs/UNI/oop/FARM-GAME-1/ncurses-6.3/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/home/spagett/docs/UNI/oop/FARM-GAME-1/ncurses-6.3/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	...
	sed	-f "/home/spagett/docs/UNI/oop/FARM-GAME-1/ncurses-6.3/man_alias.sed" \
		< "$i" >$TMP
